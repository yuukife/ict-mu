...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { andress: @contato.andress, description: @contato.description, name: @contato.name, phone: @contato.phone }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { andress: @contato.andress, description: @contato.description, name: @contato.name, phone: @contato.phone }
    assert_redirected_to contato_path(assigns(:contato))
  end
