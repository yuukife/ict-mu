...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { autor: @history.autor, capitulo: @history.capitulo, texto: @history.texto, titulo: @history.titulo }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { autor: @history.autor, capitulo: @history.capitulo, texto: @history.texto, titulo: @history.titulo }
    assert_redirected_to history_path(assigns(:history))
  end
